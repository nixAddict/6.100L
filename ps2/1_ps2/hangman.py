...
def get_word_progress(secret_word, letters_guessed):
    ...
    word_progress = ""
    for letter in secret_word:
        word_progress += letter if letter in letters_guessed else "*"
...
def get_help_letter(secret_word, available_letters):
    ...
    returns: string, a letter from secret_word that is in available_letters
    """
    choose_from = ""
    for letter in secret_word:
    ...
    while True:
        ...
        if guess.isalpha() and len(guess) == 1:
            ...
            if guesses_remaining > 3:
                guesses_remaining -= 3
                guess = get_help_letter(secret_word, available_letters)
                letters_guessed += guess
                word_progress = get_word_progress(secret_word, letters_guessed)
